<?php
/**
 * Provides fallbacks and fixes for Unique Headers plugin.
 *
 * This file contains functions that provide backwards compatibility
 * for older versions of the Unique Headers plugin. It also includes
 * a quick touchup for the WordPress database object.
 *
