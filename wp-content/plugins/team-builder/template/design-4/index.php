...
<style>
		...
		#wpsm_team_1_b_row_<?php echo esc_attr($PostId); ?> .wpsm_team_1_member_wrapper
		{
			margin:10px;
		}
		#wpsm_team_1_b_row_<?php echo esc_attr($PostId); ?> .owl-dots .owl-dot span {			
			background:<?php echo esc_attr($team_car_dots_bg_clr); ?>;			
		}
		#wpsm_team_1_b_row_<?php echo esc_attr($PostId); ?> .owl-dots .owl-dot.active span {
			background: <?php echo esc_attr($team_car_dots__hvr_bg_clr); ?>;
		}
		#wpsm_team_1_b_row_<?php echo esc_attr($PostId); ?> .owl-dots
		{
			<?php
		...
		#wpsm_team_1_b_row_<?php echo esc_attr($PostId); ?> .owl-dots .owl-dot:hover span {
			background: <?php echo esc_attr($team_car_dots__hvr_bg_clr); ?>;
		}
