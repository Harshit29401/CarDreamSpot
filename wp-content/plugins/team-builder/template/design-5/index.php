<?php if ( ! defined( 'ABSPATH' ) ) exit; ?>
	...
	<style>
			#wpsm_team_2_b_row_<?php echo esc_attr($PostId); ?> .wpsm_team_2_member_wrapper_inner h3{
			...
			#wpsm_team_2_b_row_<?php echo esc_attr($PostId); ?> .wpsm_team_2_member_wrapper
			{
				margin:10px;
			}
			
			#wpsm_team_2_b_row_<?php echo esc_attr($PostId); ?> .owl-dots .owl-dot span {			
			background:<?php echo esc_attr($team_car_dots_bg_clr); ?>;			
			}
			#wpsm_team_2_b_row_<?php echo esc_attr($PostId); ?> .owl-dots .owl-dot.active span {
				background: <?php echo esc_attr($team_car_dots__hvr_bg_clr); ?>;
			}
			#wpsm_team_2_b_row_<?php echo esc_attr($PostId); ?> .owl-dots .owl-dot:hover span {
				background: <?php echo esc_attr($team_car_dots__hvr_bg_clr); ?>;
			}
			#wpsm_team_2_b_row_<?php echo esc_attr($PostId); ?> .owl-dots
			{
				<?php
	...
	<div class="wpsm_team_2_b_row" id="wpsm_team_2_b_row_<?php echo esc_attr($PostId); ?>">
		<div class="wpsm_row">  
			<div id="wpsm-carousel-two" class="wpsm-team-owl-carousel">
			<?php 
			if($TotalCount!=-1)
			{	
				...
				foreach($All_data as $single_data)
				{
					...
					?>		
						...
						<div class="wpsm_team_2_member_wrapper">
							<img class="img-responsive wpsm_team_2_mem_img" src="<?php echo esc_url($mb_photo); ?>" alt="<?php echo esc_html($mb_name); ?>">
							<div class="wpsm_team_2_member_wrapper_inner">
								<h3>
									<?php echo esc_html($mb_name); ?>
								</h3>
								<?php if($mb_pos!="") { ?><span class="wpsm_team_2_b_desig"> <?php echo esc_html($mb_pos); ?> </span> <?php } ?>
	...
	jQuery(document).ready(function() {
	  var owl = jQuery('#wpsm-carousel-two');
	  owl.owlCarousel({
